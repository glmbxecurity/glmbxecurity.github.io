...
#### Enumeracion
SI al realizar fuzzing descubrimos el típico directorio **/cgi-bin** probablemente estemos de suerte. Una vez localizado un binario **.cgi, pl, sh**, anotamos su ubicación, ej:
```bash
